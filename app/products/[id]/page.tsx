          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <button className="w-full bg-gradient-to-r from-emerald-600 to-green-600 text-white py-4 rounded-lg hover:shadow-lg transition-all hover:scale-105 font-bold text-xl mb-4">
                {product.customizable ? "Request Custom Quote" : "Contact for Pricing"}
              </button>

              <Link href="/products">
                <button className="w-full border-2 border-emerald-600 text-emerald-600 py-4 rounded-lg hover:bg-emerald-50 transition-all font-bold text-xl">
                  View More Products
                </button>
              </Link>
            </div>
